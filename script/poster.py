...
class DouBanPoster:
    ...
    def __init__(self):
        ...
        self.template_image = Image.open('assets/template.jpg')
        self.star_yes_image = Image.open('assets/star_yes.jpg')
        self.star_no_image = Image.open('assets/star_no.jpg')
        self.star_mid_image = Image.open('assets/star_mid.jpg')
    ...
    def getFontSize(self,size,bd=False):
        ...
        if bd == True:
                return ImageFont.truetype("assets/font/msyh.ttc", size)
        return ImageFont.truetype("assets/font/msyhl.ttc", size)
    ...
    def savePoster(self,save_img_name,saveDirPath ='result'):
        ...
        # api_path = '/www/wwwroot/api.sunguoqi.com/douban_img/'

        # self.template_image.save(os.path.join(api_path,'%s_poster.png' % save_img_name),quality = 100)
...
if __name__ == '__main__':
    ...
    dbposter.backgroundImg({"bgImgPath":"assets/哪吒之魔童降世(2019)_bgImg.jpg"}
                           )
